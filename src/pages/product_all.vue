            ...
            <div class="tab-content" id="myTabContent">
              ...
              <div class="tab-pane fade show active" id="man" role="tabpanel">
                <div class="tab-single">
                  <div class="row">
                    <div class="col-xl-3 col-lg-4 col-md-4 col-12" v-for="item in list" :key="item.id">
...
export default {
  ...
  data()
    ...
    async mounted()
    {
      await axios.get("https://bb60e7d4-34be-42ed-857a-8a58c96a3868.mock.pstmn.io/categories")
      .then((response) =>
